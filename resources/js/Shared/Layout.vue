...
<!--&lt;!&ndash;              <logo class="fill-white" width="120" height="28" />&ndash;&gt;-->
<!--            </Link>-->
...
<!--&lt;!&ndash;                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">&ndash;&gt;-->
<!--&lt;!&ndash;                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" :href="`/users/${user.id}/edit`">My Profile</Link>&ndash;&gt;-->
<!--&lt;!&ndash;                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" href="/users">Manage Users</Link>&ndash;&gt;-->
<!--&lt;!&ndash;                  <Link class="block px-6 py-2 w-full text-left hover:text-white hover:bg-indigo-500" href="/logout" method="delete" as="button">Logout</Link>&ndash;&gt;-->
<!--&lt;!&ndash;                </div>&ndash;&gt;-->
